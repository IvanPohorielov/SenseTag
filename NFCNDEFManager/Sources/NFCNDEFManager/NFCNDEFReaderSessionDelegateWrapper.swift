...
public final class NFCNDEFReaderSessionDelegateWrapper: NSObject, NFCNDEFReaderSessionDelegate {
    
    // MARK: - Properties
    
    private var streamContinuation: AsyncThrowingStream<NFCNDEFTag, Error>.Continuation?
