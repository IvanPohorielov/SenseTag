...
public struct DefaultSpacings: Sendable {
    public static let spacer2: CGFloat = 2.0
    public static let spacer4: CGFloat = 4.0
    public static let spacer8: CGFloat = 8.0
    public static let spacer12: CGFloat = 12.0
    public static let spacer16: CGFloat = 16.0
    public static let spacer24: CGFloat = 24.0
    public static let spacer32: CGFloat = 32.0
    public static let spacer40: CGFloat = 40.0
    public static let spacer48: CGFloat = 48.0
    public static let spacer56: CGFloat = 56.0
}
